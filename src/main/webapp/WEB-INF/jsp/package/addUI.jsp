						...
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									...
									<td><input id="name" class="common-text required"
										 name="name" size="50" type="text" required maxlength="10">(少于10个字符)</td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>价格：</th>
									<td><input id="price" class="common-text" name="price"
										size="50" type="text" required digits="true">(请输入整数) 	
									</td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>详细描述：</th>
									<td><textarea id="detailDescribe" rows="10" cols="50"
											name="detailDescribe" required maxlength="100"></textarea>(少于100个字符)
									</td>
								</tr>
